...
import * as lambaEventSource from "aws-cdk-lib/aws-lambda-event-sources"
...
export class OrdersAppStack extends cdk.Stack {
   ...
   constructor(scope: Construct, id: string, props: OrdersAppStackProps) {
      ...
      orderEmailsHandler.addEventSource(new lambaEventSource.SqsEventSource(orderEventsQueue, {
         batchSize: 5,
         enabled: true,
